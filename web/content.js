export const defaultContent = {
      ...
      "steps": [
        {
          "icon": "fa-search",
          "title": "Assess",
          "desc": "Feasibility studies, site investigation, and geological assessment."
        },
        {
          "icon": "fa-drafting-compass",
          "title": "Design",
          "desc": "Detailed engineering design with BIM-enabled precision."
        },
        {
          "icon": "fa-hard-hat",
          "title": "Build",
          "desc": "Construction management with safety and quality focus."
        },
        {
          "icon": "fa-clipboard-check",
          "title": "Deliver",
          "desc": "Commissioning, handover, and ongoing asset support."
        }
      ]
    },
    "testimonials": [
      {
        "quote": "[Client testimonial placeholder — replace with actual quote]",
        "name": "[Client Name]",
        "role": "[Position]",
        "company": "[Company]"
      },
    ...
    "projects": [
      {
        ...
        "sector": "marine",
        "location": "[Location]",
        "desc": "[Brief description of a marine infrastructure project]",
        "stats": [
          {
            "value": "XX",
            "label": "[Metric]"
      ...
      },
      {
        ...
        "sector": "transport",
        "location": "[Location]",
        "desc": "[Brief description of a transport infrastructure project]",
        "stats": [
          {
            "value": "XX",
            "label": "[Metric]"
    ...
    "leadershipTeam": [
      {
        ...
        "desc": "With over 25 years of experience in marine and coastal infrastructure, Shaijan has led major port development and coastal protection projects across emerging markets including Mauritius, East Africa, and the Gulf."
      },
      {
        "name": "DK Sinha",
        "role": "Technical Director",
        "desc": "A veteran geotechnical engineer with expertise spanning foundation engineering, ground improvement, and transport infrastructure. DK brings deep technical rigour to every project, ensuring optimal solutions grounded in scientific principles."
      },
      {
        "name": "Shiyas",
        "role": "Operations Director",
        "desc": "Leads project execution and delivery across all operational regions, managing complex multi-site projects with a focus on safety, quality, and timely completion. Shiyas ensures seamless coordination between design, procurement, and construction teams."
      }
    ],
    "culture": {
    ...
    "timeline": [
      {
        ...
        "desc": "[Description of company milestone]"
      },
      {
        "year": "[Year]",
        "title": "[Milestone Title]",
    ...
    "differentiators": [
      {
        ...
        "desc": "Deep understanding of African, Indian, and Gulf markets with established local networks."
      },
      {
        "icon": "fa-layer-group",
        "title": "Integrated Approach",
        "desc": "End-to-end solutions from feasibility through construction to asset management."
      },
      {
        "icon": "fa-microscope",
        "title": "Geo-Engineering Focus",
        "desc": "Specialist geotechnical knowledge that optimises designs and reduces project risk."
      },
      {
        "icon": "fa-cubes",
        "title": "Modern Methods",
        "desc": "Industrialised construction technologies for faster, higher-quality delivery."
      }
    ],
    "methodology": {
      ...
      "steps": [
        {
          "icon": "fa-search",
          "title": "Assess",
          "desc": "Site investigation and feasibility analysis."
        },
        {
          "icon": "fa-drafting-compass",
          "title": "Design",
          "desc": "Detailed engineering with BIM precision."
        },
        {
          "icon": "fa-hard-hat",
          "title": "Build",
          "desc": "Quality-focused construction management."
        },
        {
          "icon": "fa-clipboard-check",
          "title": "Deliver",
          "desc": "Commissioning and asset support."
        }
      ]
    }
  },
  "marine": {
    ...
    "featuredProject": {
      "title": "[Project Name]",
      "location": "[Location]",
      "desc": "[Description of a major marine project]",
      "stats": [
        {
          "value": "XX",
          "label": "[Metric]"
  ...
  "transport": {
    ...
    "featuredProject": {
      "title": "[Project Name]",
      "location": "[Location]",
      "desc": "[Description of a major transport project]",
      "stats": [
        {
          "value": "XX",
          "label": "[Metric]"
  ...
  "systems": {
    ...
    "benefits": [
      "50-70% faster construction timelines",
      "Consistent factory quality control",
      "Up to 80% reduced on-site waste",
    ...
    "featuredProject": {
      "title": "[Project Name]",
      "location": "[Location]",
      "desc": "[Description of a major construction systems project]",
      "stats": [
        {
          "value": "XX",
          "label": "[Metric]"
    ...
    "faq": [
      {
        ...
        "answer": "We serve clients across East and Southern Africa, West Africa, the Indian Subcontinent, Gulf Cooperation Council countries, and Indian Ocean Islands, with offices in India and Mauritius."
      },
      {
        "question": "What types of projects do you take on?",
        "answer": "We deliver marine and coastal infrastructure, transport corridors, energy enabling works, and modern construction systems. Projects range from feasibility studies to full design-build delivery."
      },
      {
        "question": "How do I request a proposal?",
        "answer": "Submit a project enquiry through our contact form or email info@svgeotech.com with your project details, location, and timeline. Our team will respond with next steps."
      },
      {
