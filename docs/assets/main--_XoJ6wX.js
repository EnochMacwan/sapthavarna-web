...
`).join(""),q=e=>e.map(t=>`<li>${t}</li>`).join(""),o={home:()=>{const e=l();return`
    ...
    `},teamDetail:(e,t)=>{const i=l(),a=(window.TEAM_DATA||i.about?.team||[]).find(n=>n.name.toLowerCase().replace(/\s+/g,"-").replace(/[^a-z0-9-]/g,"")===e)||{name:"Team Member Not Found",role:"Unknown",desc:"The requested team member could not be found.",bio:"",photo:""};return`
