...
`).join(""),G=e=>e.map(t=>`<li>${t}</li>`).join(""),B=e=>!e||!e.length?"":`
    ...
    `},about:()=>{const e=l();return`
        ...
        ${a("about","leadership")?`<section id="leadership" class="section-alt">
            ...
            <div class="cards-grid team-grid">
                ${R(window.TEAM_DATA||e.about.leadershipTeam)}
            </div>
        </section>`:""}
