...
`).join(""),G=e=>e.map(t=>`<li>${t}</li>`).join(""),R=e=>!e||!e.length?"":`
        ...
        <div class="logo-grid">
            ${e.map(t=>`
                <div class="logo-grid-item">
                    ${t.logo?`<img src="${y(t.logo)}" alt="${t.name}" style="max-height:40px;">`:`<span class="logo-placeholder">${t.name}</span>`}
                </div>
            `).join("")}
        </div>
    ...
    <section class="section-alt">
    ...
    </section>`,r={home:()=>{const e=c();return`
        ...
        <section id="about" class="section-alt">
            ...
            <div class="about-grid">
                ...
                <div class="nm-card img-card nm-inset">
                    <img src="${y("materials.png")}" alt="Engineering materials" class="brand-img">
                </div>
            </div>
        </section>
        ...
        <section class="section-alt">
            ...
            <div class="projects-grid">
                ${e.home.projects.map(t=>m(t,t.sector)).join("")}
            </div>
        </section>`:""}

        ${E(e.home.process)}

        ${F(e.home.testimonials)}
            ...
            <div class="partners-grid">
                ${e.about.partners.map(t=>`
                    <div class="partner-card">
                        ${t.logo?`<img src="${y(t.logo)}" alt="${t.name}" style="max-height:40px;">`:`<span>${t.name}</span>`}
                    </div>
                `).join("")}
            </div>
        </section>`:""}
    ...
    `},capabilities:()=>{const e=c();return`
        ...
        ${e.capabilities.differentiators?`
        <section>
    ...
    `},transport:()=>{const e=c();return`
        ...
        ${e.transport.featuredProject?`
        <section class="section-alt">
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${m(e.transport.featuredProject,"transport")}
            </div>
        </section>`:""}

        ${f(e.transport.whyChooseUs)}
    ...
    `},energy:()=>{const e=c();return`
        ...
        ${e.energy.featuredProject?`
        <section class="section-alt">
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${m(e.energy.featuredProject,"energy")}
            </div>
        </section>`:""}

        ${f(e.energy.whyChooseUs)}
    ...
    `},systems:()=>{const e=c();return`
        ...
        <section id="technologies">
            ...
            <div class="cards-grid">
                ${e.systems.technologies.map((t,i)=>`
                    <div class="nm-card">
                        ${t.image?`<div class="card-image nm-inset mb-4"><img src="${y(t.image)}" alt="${t.title}" class="brand-img" style="height: 200px;"></div>`:""}
                        <div class="service-number">${String(i+1).padStart(2,"0")}</div>
                        <h3>${t.title}</h3>
                        <p class="text-secondary mt-4">${t.desc}</p>
                    </div>
        ...
        ${e.systems.featuredProject?`
        <section>
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${m(e.systems.featuredProject,"systems")}
            </div>
        </section>`:""}

        ${f(e.systems.whyChooseUs)}
    ...
    <footer class="main-footer">
        ...
        <div class="footer-bottom">
            ...
            <div class="legal-links">
                <a href="${P}/admin.html" class="admin-link">Admin</a>
            </div>
        </div>
    </footer>
    `}};function _(){let e=document.getElementById("header-mount");e||(e=document.createElement("div"),e.id="header-mount",document.body.insertBefore(e,document.body.firstChild)),e.innerHTML=I.header();let t=document.getElementById("footer-mount");t||(t=document.createElement("div"),t.id="footer-mount",document.body.appendChild(t)),t.innerHTML=I.footer(),M()}function M(){const e=window.location.hash.replace("#","").split("?")[0];document.querySelectorAll(".nav-link").forEach(t=>{const i=t.getAttribute("href")||"",s=i.startsWith("#")?i.substring(1):"";e===s||e===""&&s===""?t.classList.add("active"):t.classList.remove("active")})}let b=null,u=null;const L=()=>{b&&(b.destroy(),b=null),u&&(u.disconnect(),u=null),document.getElementById("spectrum-canvas")&&(b=new z("spectrum-canvas"));const t={threshold:.05,rootMargin:"0px 0px -30px 0px"};u=new IntersectionObserver(s=>{s.forEach(a=>{a.isIntersecting&&(gsap.to(a.target,{opacity:1,y:0,duration:.7,ease:"power2.out",delay:a.target.dataset.delay||0}),u.unobserve(a.target))})},t),document.querySelectorAll(".nm-card, .grid-card-wrapper").forEach(s=>{gsap.set(s,{opacity:0,y:15});const a=s.parentElement;if(a&&(a.classList.contains("cards-grid")||a.classList.contains("careers-grid")||a.classList.contains("benefits-grid")||a.classList.contains("team-grid")||a.classList.contains("stats-bar")||a.classList.contains("process-grid")||a.classList.contains("certs-grid")||a.classList.contains("why-grid")||a.classList.contains("testimonials-grid")||a.classList.contains("projects-grid"))){const o=Array.from(a.children).indexOf(s);s.dataset.delay=(o*.06).toFixed(2)}u.observe(s)}),M()},Y=()=>{document.querySelectorAll(".nav-item-has-mega").forEach(t=>{const i=t.querySelectorAll(".mega-links li");t.addEventListener("mouseenter",()=>{gsap.fromTo(i,{opacity:0,x:-5},{opacity:1,x:0,stagger:.05,duration:.4,ease:"power2.out",delay:.1})})}),gsap.from("nav",{y:-10,opacity:0,duration:.8,ease:"power2.out"})};document.addEventListener("DOMContentLoaded",()=>{_();const e=document.getElementById("app");new H(e),Y(),window.addEventListener("routeChange",()=>{L(),T()}),L(),T()});window.handleEOISubmit=e=>{e.preventDefault();const t=e.target,i=new FormData(t),s=Object.fromEntries(i.entries());s.submittedAt=new Date().toISOString();const a=JSON.parse(localStorage.getItem("eoi_submissions")||"[]");a.push(s),localStorage.setItem("eoi_submissions",JSON.stringify(a)),t.style.display="none",document.getElementById("eoi-success").style.display="block",document.getElementById("eoi-success").scrollIntoView({behavior:"smooth",block:"center"})};const T=()=>{const e=document.getElementById("contact-form");e&&(e.addEventListener("submit",t=>{t.preventDefault();let i=!0;const s=document.getElementById("contact-name"),a=document.getElementById("contact-email"),n=document.getElementById("contact-message");if([s,a,n].forEach(d=>{d.classList.remove("valid","invalid"),d.value.trim()?d.classList.add("valid"):(d.classList.add("invalid"),i=!1)}),a.value&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(a.value)&&(a.classList.remove("valid"),a.classList.add("invalid"),i=!1),!i)return;const o={name:s.value,company:document.getElementById("contact-company").value,email:a.value,phone:document.getElementById("contact-phone").value,sector:document.getElementById("contact-sector").value,region:document.getElementById("contact-region").value,message:n.value,submittedAt:new Date().toISOString()},l=JSON.parse(localStorage.getItem("contact_submissions")||"[]");l.push(o),localStorage.setItem("contact_submissions",JSON.stringify(l)),e.style.display="none";const h=document.getElementById("contact-success");h.style.display="block",h.scrollIntoView({behavior:"smooth",block:"center"})}),e.querySelectorAll(".form-input[required]").forEach(t=>{t.addEventListener("blur",()=>{t.classList.remove("valid","invalid"),t.value.trim()&&(t.type==="email"&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t.value)?t.classList.add("invalid"):t.classList.add("valid"))})}))},J=()=>{const e=document.createElement("button");e.className="back-to-top",e.setAttribute("aria-label","Back to top"),e.innerHTML='<i class="fas fa-arrow-up"></i>',document.body.appendChild(e),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),window.addEventListener("scroll",()=>{window.scrollY>400?e.classList.add("visible"):e.classList.remove("visible")})},K=()=>{const e=document.querySelector("nav");if(!e)return;const t=document.createElement("div");t.className="hamburger",t.innerHTML="<span></span><span></span><span></span>",t.setAttribute("aria-label","Toggle menu");const i=document.createElement("div");i.className="mobile-nav",i.innerHTML=`
    ...
    `;const s=e.querySelector(".nav-container");s&&s.appendChild(t),document.body.appendChild(i),t.addEventListener("click",()=>{t.classList.toggle("active"),i.classList.toggle("active"),document.body.style.overflow=i.classList.contains("active")?"hidden":""}),i.querySelectorAll("a").forEach(a=>{a.addEventListener("click",()=>{t.classList.remove("active"),i.classList.remove("active"),document.body.style.overflow=""})})},A=()=>{document.querySelectorAll(".form-input").forEach(e=>{e.addEventListener("blur",()=>{if(e.required&&!e.value.trim())e.classList.add("invalid"),e.classList.remove("valid");else if(e.type==="email"&&e.value){const t=/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e.value);e.classList.toggle("valid",t),e.classList.toggle("invalid",!t)}else e.value.trim()&&(e.classList.add("valid"),e.classList.remove("invalid"))}),e.addEventListener("input",()=>{e.classList.remove("invalid")})})},Q=()=>{const e=document.getElementById("newsletter-form");e&&e.addEventListener("submit",t=>{t.preventDefault();const i=e.querySelector(".newsletter-input");if(i&&i.value&&/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(i.value)){const s=JSON.parse(localStorage.getItem("newsletter_subs")||"[]");s.push({email:i.value,subscribedAt:new Date().toISOString()}),localStorage.setItem("newsletter_subs",JSON.stringify(s)),i.value="";const a=e.querySelector(".newsletter-btn");a.textContent="Subscribed!",setTimeout(()=>{a.textContent="Subscribe"},3e3)}})};document.addEventListener("DOMContentLoaded",()=>{J(),K(),A(),Q()});window.addEventListener("routeChange",()=>{A()});
