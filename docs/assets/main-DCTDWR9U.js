...
`).join(""),R=e=>e.map(t=>`<li>${t}</li>`).join(""),B=e=>!e||!e.length?"":`
    <section class="section-alt">
        <div class="stats-bar">
            ${e.map(t=>`
                <div class="stat-item nm-card">
                    <div class="stat-icon"><i class="fas ${t.icon}"></i></div>
                    <div class="stat-value">${t.value}</div>
                    <div class="stat-label">${t.label}</div>
                </div>
            `).join("")}
        </div>
    </section>`,V=e=>!e||!e.length?"":`
    <section class="section-center">
        <div class="section-label mb-4">Trusted By</div>
        <div class="logo-grid">
            ${e.map(t=>`
                <div class="logo-grid-item">
                    ${t.logo?`<img src="${w(t.logo)}" alt="${t.name}" style="max-height:40px;">`:`<span class="logo-placeholder">${t.name}</span>`}
                </div>
            `).join("")}
        </div>
    </section>`,F=e=>!e||!e.length?"":`
    <section class="section-alt">
    ...
    <div class="project-card nm-card" style="padding:0;overflow:hidden;">
        <div class="project-card-visual ${t?`${t}-gradient`:""}">
    ...
    <section style="padding:0;">
        <div class="trust-strip">
            ...
            <div class="trust-badges">
                ${e.badges.map(t=>`
                    <div class="trust-badge"><i class="fas ${t.icon}"></i> ${t.label}</div>
                `).join("")}
            </div>
        </div>
    </section>`:"",E=e=>e?`
        ...
        <div class="process-grid">
            ${e.steps.map((t,i)=>`
                <div class="process-step nm-card">
                    <div class="process-icon"><i class="fas ${t.icon}"></i></div>
        ...
        <div class="sector-stats">
            ${e.map(t=>`
                <div class="sector-stat">
                    <div class="sector-stat-value">${t.value}</div>
                    <div class="sector-stat-label">${t.label}</div>
                </div>
            `).join("")}
        </div>
    ...
    <section class="section-alt">
        ...
        <div class="why-grid">
            ${e.map(t=>`
                <div class="nm-card why-card">
                    <div class="diff-icon"><i class="fas ${t.icon}"></i></div>
                    <h3>${t.title}</h3>
                    <p>${t.desc}</p>
                </div>
            `).join("")}
        ...
        ${a("home","hero")?`<section id="hero" class="hero">
        ...
        ${a("home","stats")?B(e.home.stats):""}

        ${a("home","clientLogos")?V(e.home.clientLogos):""}

        ${a("home","about")?`<section id="about" class="section-alt">
            ...
            <div class="about-grid">
                ...
                <div class="nm-card img-card nm-inset">
                    <img src="${w("materials.png")}" alt="Engineering materials" class="brand-img">
                </div>
            </div>
        </section>`:""}

        ${a("home","capabilities")?`<section id="capabilities">
        ...
        ${a("home","projects")&&e.home.projects?`
        <section class="section-alt">
            <div class="section-label mb-4">Our Work</div>
            <h2 class="mb-6" style="text-align:center;">Featured Projects</h2>
            <div class="projects-grid">
                ${e.home.projects.map(t=>h(t,t.sector)).join("")}
            </div>
        </section>`:""}

        ${a("home","process")?E(e.home.process):""}

        ${a("home","testimonials")?F(e.home.testimonials):""}

        ${a("home","trustStrip")?N(e.home.trustStrip):""}

        ${a("home","closing")?`<section id="closing" class="section-alt section-center">
            <h2 class="mb-6">${e.home.closing.title}</h2>
            <a href="#contact" class="cta-button nav-link">${e.home.closing.cta} →</a>
        </section>`:""}
    `},about:()=>{const e=l();return`
        ${a("about","hero")?`<section id="about-hero" class="subpage-hero">
        ...
        ${a("about","company")?`<section id="company" class="section-alt">
        ...
        ${a("about","partners")&&e.about.partners?`
        <section class="section-alt">
            <div class="section-label mb-4">Associations</div>
            <h2 class="mb-6" style="text-align:center;">Partners & Associations</h2>
            <div class="partners-grid">
                ${e.about.partners.map(t=>`
                    <div class="partner-card">
                        ${t.logo?`<img src="${w(t.logo)}" alt="${t.name}" style="max-height:40px;">`:`<span>${t.name}</span>`}
                    </div>
                `).join("")}
            </div>
        </section>`:""}

        ${a("about","culture")?`<section id="culture">
        ...
        ${a("about","careers")?`<section id="careers" class="section-alt section-center">
    ...
    `},capabilities:()=>{const e=l();return`
        ${a("capabilities","hero")?`<section id="cap-hero" class="subpage-hero">
        ...
        ${a("capabilities","overview")?`<section id="overview" class="section-alt">
            <p class="lead-text">${e.capabilities.overview.desc}</p>
        </section>`:""}

        ${a("capabilities","differentiators")&&e.capabilities.differentiators?`
        <section>
            <div class="section-label mb-4">Our Edge</div>
            <h2 class="mb-6" style="text-align:center;">Why SVGT</h2>
            <div class="cards-grid">
                ${e.capabilities.differentiators.map(t=>`
                    <div class="nm-card">
                        <div class="diff-icon"><i class="fas ${t.icon}"></i></div>
                        <h3>${t.title}</h3>
                        <p class="text-secondary mt-4">${t.desc}</p>
        ...
        ${a("capabilities","sectors")?`<section id="sectors" class="section-alt">
        ...
        ${a("capabilities","methodology")?E(e.capabilities.methodology):""}

        ${a("capabilities","cta")?`<section class="section-center">
    ...
    `},marine:()=>{const e=l();return`
        ${a("marine","hero")?`<section id="marine-hero" class="subpage-hero marine-bg">
        ...
        ${a("marine","sectorStats")?g(e.marine.sectorStats):""}

        ${a("marine","intro")?`<section id="marine-intro" class="section-alt">
            <p class="lead-text">${e.marine.intro.desc}</p>
        </section>`:""}

        ${a("marine","services")?`<section id="marine-services">
        ...
        ${a("marine","featuredProject")&&e.marine.featuredProject?`
        <section class="section-alt">
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${h(e.marine.featuredProject)}
            </div>
        </section>`:""}

        ${a("marine","whyChooseUs")?b(e.marine.whyChooseUs):""}

        ${a("marine","cta")?`<section id="marine-cta" class="section-center">
            <h2 class="mb-6">Ready to discuss your marine project?</h2>
            <a href="#contact" class="cta-button nav-link">Get in Touch →</a>
        </section>`:""}
    `},transport:()=>{const e=l();return`
        ${a("transport","hero")?`<section id="transport-hero" class="subpage-hero transport-bg">
        ...
        ${a("transport","sectorStats")?g(e.transport.sectorStats):""}

        ${a("transport","intro")?`<section id="transport-intro" class="section-alt">
            <p class="lead-text">${e.transport.intro.desc}</p>
        </section>`:""}

        ${a("transport","services")?`<section id="transport-services">
            <div class="section-label mb-4">What We Deliver</div>
            <h2 class="mb-6">Our Services</h2>
            <div class="cards-grid services-grid">
        ...
        ${a("transport","featuredProject")&&e.transport.featuredProject?`
        <section class="section-alt">
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${h(e.transport.featuredProject,"transport")}
            </div>
        </section>`:""}

        ${a("transport","whyChooseUs")?b(e.transport.whyChooseUs):""}

        ${a("transport","cta")?`<section id="transport-cta" class="section-center">
            <h2 class="mb-6">Ready to discuss your transport project?</h2>
            <a href="#contact" class="cta-button nav-link">Get in Touch →</a>
        </section>`:""}
    `},energy:()=>{const e=l();return`
        ${a("energy","hero")?`<section id="energy-hero" class="subpage-hero energy-bg">
        ...
        ${a("energy","sectorStats")?g(e.energy.sectorStats):""}

        ${a("energy","intro")?`<section id="energy-intro" class="section-alt">
            <p class="lead-text">${e.energy.intro.desc}</p>
        </section>`:""}

        ${a("energy","services")?`<section id="energy-services">
            <div class="section-label mb-4">What We Deliver</div>
            <h2 class="mb-6">Our Services</h2>
            <div class="cards-grid services-grid">
                ${k(e.energy.services)}
        ...
        ${a("energy","featuredProject")&&e.energy.featuredProject?`
        <section class="section-alt">
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${h(e.energy.featuredProject,"energy")}
            </div>
        </section>`:""}

        ${a("energy","whyChooseUs")?b(e.energy.whyChooseUs):""}

        ${a("energy","cta")?`<section id="energy-cta" class="section-center">
            <h2 class="mb-6">Ready to discuss your energy project?</h2>
            <a href="#contact" class="cta-button nav-link">Get in Touch →</a>
        </section>`:""}
    `},systems:()=>{const e=l();return`
        ${a("systems","hero")?`<section id="systems-hero" class="subpage-hero systems-bg">
        ...
        ${a("systems","sectorStats")?g(e.systems.sectorStats):""}

        ${a("systems","intro")?`<section id="systems-intro" class="section-alt">
            <p class="lead-text">${e.systems.intro.desc}</p>
        </section>`:""}

        ${a("systems","technologies")?`<section id="technologies">
            <div class="section-label mb-4">Our Solutions</div>
            <h2 class="mb-6">Our Technologies</h2>
            <div class="cards-grid">
                ${e.systems.technologies.map((t,i)=>`
                    <div class="nm-card">
                        ${t.image?`<div class="card-image nm-inset mb-4"><img src="${w(t.image)}" alt="${t.title}" class="brand-img" style="height: 200px;"></div>`:""}
                        <div class="service-number">${String(i+1).padStart(2,"0")}</div>
                        <h3>${t.title}</h3>
                        <p class="text-secondary mt-4">${t.desc}</p>
                    </div>
        ...
        ${a("systems","benefits")?`<section id="benefits" class="section-alt">
            <div class="nm-card">
        ...
        ${a("systems","featuredProject")&&e.systems.featuredProject?`
        <section>
            <div class="section-label mb-4">Project Spotlight</div>
            <h2 class="mb-6" style="text-align:center;">Featured Project</h2>
            <div style="max-width:600px;margin:0 auto;">
                ${h(e.systems.featuredProject,"systems")}
            </div>
        </section>`:""}

        ${a("systems","whyChooseUs")?b(e.systems.whyChooseUs):""}

        ${a("systems","cta")?`<section id="systems-cta" class="section-center">
            <h2 class="mb-6">Interested in modern construction systems?</h2>
            <a href="#contact" class="cta-button nav-link">Get in Touch →</a>
        </section>`:""}
    `},sustainability:()=>{const e=l();return`
        ${a("sustainability","hero")?`<section id="sustain-hero" class="subpage-hero">
        ...
        ${a("sustainability","plan")?`<section id="plan" class="section-alt">
        ...
        ${a("sustainability","metrics")&&e.sustainability.metrics?`
        <section class="section-center">
            <div class="sector-stats">
                ${e.sustainability.metrics.map(t=>`
                    <div class="sector-stat">
                        <div style="font-size:1.5rem;color:var(--accent-marine);margin-bottom:8px;"><i class="fas ${t.icon}"></i></div>
                        <div class="sector-stat-value">${t.value}</div>
                        <div class="sector-stat-label">${t.label}</div>
                    </div>
                `).join("")}
        ...
        ${a("sustainability","pillars")?`<section id="pillars" class="section-alt">
        ...
        ${a("sustainability","practices")?`<section id="practices">
        ...
        ${a("sustainability","cta")?`<section class="section-alt section-center">
            <h2 class="mb-6">Partner with us on sustainable infrastructure</h2>
            <a href="#contact" class="cta-button nav-link">Get in Touch →</a>
        </section>`:""}
    `},contact:()=>{const e=l();return`
        ${a("contact","hero")?`<section id="contact-hero" class="subpage-hero contact-hero-bg">
        ...
        ${a("contact","form")?`<section id="contact-form-section" class="section-alt">
                        ...
                        <div class="offices-list">
                            ${e.contact.offices.locations.map(t=>`
                                <div class="office-item">
                                    ...
                                    <div>
                                        <strong>${t.country}</strong> · ${t.city}
                                        <span class="text-secondary" style="display:block; font-size: 0.85rem;">${t.type}</span>
                                        <span class="text-secondary" style="display:block; font-size: 0.85rem;">${t.address}</span>
                                    </div>
                                </div>
                            `).join("")}
                        </div>
        ...
        ${a("contact","faq")?H(e.contact.faq):""}
    `},careers:()=>`
        ${a("careers","hero")?`<section id="careers-hero" class="page-hero careers-hero">
            <div class="hero-overlay-content">
        ...
        ${a("careers","intro")?`<section id="careers-intro" class="section-alt">
        ...
        ${a("careers","categories")?`<section id="job-categories">
        ...
        ${a("careers","whyJoin")?`<section id="why-join" class="section-alt">
        ...
        ${a("careers","eoiForm")?`<section id="eoi-form">
        ...
        ${a("careers","contact")?`<section id="careers-contact" class="section-alt section-center">
    ...
    `};class U{constructor(t){this.mountPoint=t,this._routeVersion=0,this.routes={"":c.home,"/":c.home,about:c.about,capabilities:c.capabilities,marine:c.marine,transport:c.transport,energy:c.energy,systems:c.systems,sustainability:c.sustainability,contact:c.contact,careers:c.careers},window.addEventListener("hashchange",()=>this.handleRoute()),document.addEventListener("click",i=>this.interceptClick(i)),this.handleRoute()}interceptClick(t){const i=t.target.closest("a");if(i&&i.classList.contains("nav-link")){const s=i.getAttribute("href");if(s&&s.startsWith("/")&&!s.startsWith("//")){t.preventDefault();const n=s==="/"?"":s.substring(1);window.location.hash=n}}}navigate(t){window.location.hash=t}getHashPath(){let t=window.location.hash.substring(1);return t.startsWith("/")&&(t=t.substring(1)),t}async handleRoute(){const t=++this._routeVersion,i=this.mountPoint;if(window.gsap&&await window.gsap.to(i,{opacity:0,y:10,duration:.3,ease:"power2.in"}),t!==this._routeVersion)return;const s=this.getHashPath(),n=this.routes[s]||c.home;i.innerHTML=n(),window.scrollTo(0,0),window.gsap&&window.gsap.fromTo(i,{opacity:0,y:10},{opacity:1,y:0,duration:.5,ease:"power2.out"}),window.dispatchEvent(new CustomEvent("routeChange",{detail:{path:s}}))}}class z{constructor(t){this.canvas=document.getElementById(t),this.canvas&&(this.ctx=this.canvas.getContext("2d",{alpha:!0}),this.particles=[],this.sparks=[],this.worker={x:0,y:0,tx:0,ty:0,state:"idle",targetIdx:-1,weldTime:0,frame:0},this.mouse={x:-1e3,y:-1e3},this.dpr=Math.min(window.devicePixelRatio||1,3),this.themeColor="#003366",this.accentColor="#C69061",this.active=!0,this._resizeHandler=()=>this.resize(),this._mouseMoveHandler=i=>this.handleMouseMove(i),document.fonts?document.fonts.ready.then(()=>{this.active&&this.init()}):this.init(),this.animate(),window.addEventListener("resize",this._resizeHandler),window.addEventListener("mousemove",this._mouseMoveHandler),window.resetBrandBuild=()=>this.init())}init(){this.resize(),this.particles=[],this.sparks=[];const t=document.createElement("canvas"),i=t.getContext("2d"),s=2,n=1200*s,r=220*s;t.width=n,t.height=r,i.fillStyle="black",i.font=`bold ${100*s}px Inter, system-ui, sans-serif`,i.textAlign="center",i.textBaseline="middle",i.fillText("SAPTHAVARNAH",n/2,r/2);const o=i.getImageData(0,0,n,r).data,d=window.innerWidth<768,p=this.dpr>=2,u=d?10*s:p?5*s:6*s,$=this.canvas.width/this.dpr,x=this.canvas.height/this.dpr;for(let v=0;v<r;v+=u)for(let f=0;f<n;f+=u){const X=(v*n+f)*4;if(o[X+3]>128){const S=$/2-n/s/2+f/s,q=x*.82-r/s/2+v/s,C=Math.random()>.4,W=C?8:5;this.particles.push({tx:S,ty:q,x:S+(Math.random()-.5)*50,y:-Math.random()*1500-100,vx:0,vy:5+Math.random()*10,c:C?this.accentColor:this.themeColor,size:W,delay:Math.random()*150,landed:!1,welded:!1,bounce:0})}}this.worker={x:$/2,y:x,tx:$/2,ty:x*.8,state:"idle",targetIdx:-1,weldTime:0,frame:0,scale:1.8}}resize(){if(!this.canvas)return;const t=this.canvas.parentElement;this.canvas.width=t.offsetWidth*this.dpr,this.canvas.height=t.offsetHeight*this.dpr,this.canvas.style.width=t.offsetWidth+"px",this.canvas.style.height=t.offsetHeight+"px",this.ctx.setTransform(1,0,0,1,0,0),this.ctx.scale(this.dpr,this.dpr),this.ctx.imageSmoothingEnabled=!1}handleMouseMove(t){if(!this.canvas)return;const i=this.canvas.getBoundingClientRect();this.mouse.x=t.clientX-i.left,this.mouse.y=t.clientY-i.top}updateWorker(){if(this.worker.frame++,this.worker.state==="idle"||this.worker.state==="walking"){let t=1/0,i=-1;this.particles.forEach((s,n)=>{if(s.landed&&!s.welded){const r=s.tx-this.worker.x,o=s.ty-this.worker.y,d=r*r+o*o;d<t&&(t=d,i=n)}}),i!==-1&&(this.worker.targetIdx=i,this.worker.tx=this.particles[i].tx,this.worker.ty=this.particles[i].ty,this.worker.state="walking")}if(this.worker.state==="walking"){const t=this.worker.tx-this.worker.x,i=this.worker.ty-(this.worker.y-15);Math.sqrt(t*t+i*i)<10?(this.worker.state="welding",this.worker.weldTime=40):(this.worker.x+=t*.12,this.worker.y+=i*.12)}this.worker.state==="welding"&&(this.worker.weldTime>0?(this.worker.weldTime--,Math.random()>.5&&this.sparks.push({x:this.worker.x+10,y:this.worker.y-15,vx:(Math.random()-.5)*8,vy:-Math.random()*6-2,life:20+Math.random()*20})):(this.worker.targetIdx!==-1&&(this.particles[this.worker.targetIdx].welded=!0),this.worker.state="idle"))}drawWorker(){const{x:t,y:i,state:s,frame:n,scale:r}=this.worker,o=s==="walking"?Math.sin(n*.25)*4:0;this.ctx.save(),this.ctx.translate(t,i+o),this.ctx.scale(r,r),this.ctx.fillStyle="#1a202c",this.ctx.fillRect(-5,-6,3,6),this.ctx.fillRect(2,-6,3,6),this.ctx.fillStyle="#f6ad55",this.ctx.fillRect(-7,-22,14,16),this.ctx.fillStyle="rgba(255,255,255,0.9)",this.ctx.fillRect(-7,-18,14,2),this.ctx.fillRect(-7,-12,14,2),this.ctx.fillStyle="#4a5568",s==="welding"?this.ctx.fillRect(2,-18,12,3):(this.ctx.fillRect(7,-18,3,10),this.ctx.fillRect(-10,-18,3,10)),this.ctx.fillStyle="#f6e05e",this.ctx.beginPath(),this.ctx.arc(0,-25,6,Math.PI,0),this.ctx.fill(),this.ctx.fillRect(-8,-25,16,2),this.ctx.restore()}animate(){if(!this.active||!this.canvas)return;const t=this.canvas.width/this.dpr,i=this.canvas.height/this.dpr;this.ctx.clearRect(0,0,t,i),this.ctx.shadowBlur=0,this.particles.forEach(s=>{if(s.delay>0){s.delay--;return}s.landed?(s.x+=(s.tx-s.x)*.1,s.y+=(s.ty-s.y)*.1,s.bounce>0&&(s.y-=s.bounce,s.bounce*=-.5)):(s.y+=s.vy,s.vy+=.3,s.y>=s.ty&&(s.y=s.ty,s.landed=!0,s.bounce=6)),this.ctx.fillStyle=s.c,this.ctx.beginPath(),this.ctx.roundRect(s.x,s.y,s.size,s.size*.6,1),this.ctx.fill(),s.welded&&(this.ctx.fillStyle="rgba(255, 255, 255, 0.15)",this.ctx.fillRect(s.x,s.y,s.size,s.size*.15))}),this.sparks=this.sparks.filter(s=>{s.x+=s.vx,s.y+=s.vy,s.vy+=.3,s.life--;const n=s.life/40;return this.ctx.fillStyle=`rgba(255, 200, 50, ${n})`,this.ctx.beginPath(),this.ctx.arc(s.x,s.y,2,0,Math.PI*2),this.ctx.fill(),s.life>0}),this.updateWorker(),this.drawWorker(),requestAnimationFrame(()=>this.animate())}destroy(){this.active=!1,window.removeEventListener("resize",this._resizeHandler),window.removeEventListener("mousemove",this._mouseMoveHandler),this.canvas=null}}const T="/sapthavarna-web/".replace(/\/$/,"")||"",I=e=>`${T}/${e}`;function Y(){const e=window.NAV_DATA;if(!e)return null;let t="";return(e.megaMenus||[]).forEach(i=>{t+=`<div class="nav-item-has-mega">
            <a href="${i.href}" class="nav-link">${i.label}</a>
            <div class="mega-menu">`,(i.columns||[]).forEach(s=>{t+=`<div class="mega-col"><h5>${s.heading}</h5>`,s.type==="text"?t+=`<p class="mega-desc">${s.text}</p>`:(t+='<ul class="mega-links">',(s.links||[]).forEach(n=>{t+=`<li><a href="${n.href}">${n.text}</a></li>`}),t+="</ul>"),t+="</div>"}),t+="</div></div>"}),(e.standaloneLinks||[]).forEach(i=>{t+=`<a href="${i.href}" class="nav-link">${i.label}</a>`}),t}const P={header:()=>{const t=Y()||`
    ...
    <nav class="pill-nav">
        <div class="nav-container">
            <a href="#" class="logo nav-link" aria-label="SapthaVarnah Home">
                <div class="logo-crop">
                    <img src="${I("logo-master.png")}" alt="SapthaVarnah Logo" class="logo-img-master">
                </div>
    ...
    `},footer:()=>{let e={};try{const t=localStorage.getItem("siteContent");e=(t?JSON.parse(t):null)?.shared||{}}catch{}return`
    <footer class="main-footer">
        ...
        <div class="footer-bottom">
            ...
            <div class="legal-links">
                <a href="${T}/admin.html" class="admin-link">Admin</a>
            </div>
        </div>
    </footer>
    `}};function _(){let e=document.getElementById("header-mount");e||(e=document.createElement("div"),e.id="header-mount",document.body.insertBefore(e,document.body.firstChild)),e.innerHTML=P.header();let t=document.getElementById("footer-mount");t||(t=document.createElement("div"),t.id="footer-mount",document.body.appendChild(t)),t.innerHTML=P.footer(),A()}function A(){const e=window.location.hash.replace("#","").split("?")[0];document.querySelectorAll(".nav-link").forEach(t=>{const i=t.getAttribute("href")||"",s=i.startsWith("#")?i.substring(1):"";e===s||e===""&&s===""?t.classList.add("active"):t.classList.remove("active")})}let y=null,m=null;const L=()=>{y&&(y.destroy(),y=null),m&&(m.disconnect(),m=null),document.getElementById("spectrum-canvas")&&(y=new z("spectrum-canvas"));const t={threshold:.05,rootMargin:"0px 0px -30px 0px"};m=new IntersectionObserver(s=>{s.forEach(n=>{n.isIntersecting&&(gsap.to(n.target,{opacity:1,y:0,duration:.7,ease:"power2.out",delay:n.target.dataset.delay||0}),m.unobserve(n.target))})},t),document.querySelectorAll(".nm-card, .grid-card-wrapper").forEach(s=>{gsap.set(s,{opacity:0,y:15});const n=s.parentElement;if(n&&(n.classList.contains("cards-grid")||n.classList.contains("careers-grid")||n.classList.contains("benefits-grid")||n.classList.contains("team-grid")||n.classList.contains("stats-bar")||n.classList.contains("process-grid")||n.classList.contains("certs-grid")||n.classList.contains("why-grid")||n.classList.contains("testimonials-grid")||n.classList.contains("projects-grid"))){const o=Array.from(n.children).indexOf(s);s.dataset.delay=(o*.06).toFixed(2)}m.observe(s)}),A()},J=()=>{document.querySelectorAll(".nav-item-has-mega").forEach(t=>{const i=t.querySelectorAll(".mega-links li");t.addEventListener("mouseenter",()=>{gsap.fromTo(i,{opacity:0,x:-5},{opacity:1,x:0,stagger:.05,duration:.4,ease:"power2.out",delay:.1})})}),gsap.from("nav",{y:-10,opacity:0,duration:.8,ease:"power2.out"})};document.addEventListener("DOMContentLoaded",()=>{_();const e=document.getElementById("app");new U(e),J(),window.addEventListener("routeChange",()=>{L(),M()}),L(),M()});window.handleEOISubmit=e=>{e.preventDefault();const t=e.target,i=new FormData(t),s=Object.fromEntries(i.entries());s.submittedAt=new Date().toISOString();const n=JSON.parse(localStorage.getItem("eoi_submissions")||"[]");n.push(s),localStorage.setItem("eoi_submissions",JSON.stringify(n)),t.style.display="none",document.getElementById("eoi-success").style.display="block",document.getElementById("eoi-success").scrollIntoView({behavior:"smooth",block:"center"})};const M=()=>{const e=document.getElementById("contact-form");e&&(e.addEventListener("submit",t=>{t.preventDefault();let i=!0;const s=document.getElementById("contact-name"),n=document.getElementById("contact-email"),r=document.getElementById("contact-message");if([s,n,r].forEach(u=>{u.classList.remove("valid","invalid"),u.value.trim()?u.classList.add("valid"):(u.classList.add("invalid"),i=!1)}),n.value&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(n.value)&&(n.classList.remove("valid"),n.classList.add("invalid"),i=!1),!i)return;const o={name:s.value,company:document.getElementById("contact-company").value,email:n.value,phone:document.getElementById("contact-phone").value,sector:document.getElementById("contact-sector").value,region:document.getElementById("contact-region").value,message:r.value,submittedAt:new Date().toISOString()},d=JSON.parse(localStorage.getItem("contact_submissions")||"[]");d.push(o),localStorage.setItem("contact_submissions",JSON.stringify(d)),e.style.display="none";const p=document.getElementById("contact-success");p.style.display="block",p.scrollIntoView({behavior:"smooth",block:"center"})}),e.querySelectorAll(".form-input[required]").forEach(t=>{t.addEventListener("blur",()=>{t.classList.remove("valid","invalid"),t.value.trim()&&(t.type==="email"&&!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t.value)?t.classList.add("invalid"):t.classList.add("valid"))})}))},K=()=>{const e=document.createElement("button");e.className="back-to-top",e.setAttribute("aria-label","Back to top"),e.innerHTML='<i class="fas fa-arrow-up"></i>',document.body.appendChild(e),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}),window.addEventListener("scroll",()=>{window.scrollY>400?e.classList.add("visible"):e.classList.remove("visible")})},Q=()=>{const e=document.querySelector("nav");if(!e)return;const t=document.createElement("div");t.className="hamburger",t.innerHTML="<span></span><span></span><span></span>",t.setAttribute("aria-label","Toggle menu");const i=document.createElement("div");i.className="mobile-nav",i.innerHTML=`
