...
`).join(""),R=e=>e.map(t=>`<li>${t}</li>`).join(""),B=e=>!e||!e.length?"":`
    ...
    <section class="section-alt">
        ...
        ${a("home","clientLogos")?F(e.home.clientLogos):""}
        ...
        ${a("home","testimonials")?V(e.home.testimonials):""}
    ...
    `},marine:()=>{const e=l();return`
        ...
        ${a("marine","sectorStats")?f(e.marine.sectorStats):""}
    ...
    `},transport:()=>{const e=l();return`
        ...
        ${a("transport","sectorStats")?f(e.transport.sectorStats):""}
    ...
    `},energy:()=>{const e=l();return`
        ...
        ${a("energy","sectorStats")?f(e.energy.sectorStats):""}
    ...
    `},systems:()=>{const e=l();return`
        ...
        ${a("systems","sectorStats")?f(e.systems.sectorStats):""}
    ...
    <nav class="pill-nav">
        <div class="nav-container">
            <a href="#" class="logo nav-link" aria-label="SapthaVarnah Home">
                <div class="logo-crop">
                    <img src="${P("logo-master.png")}" alt="SapthaVarnah Logo" class="logo-img-master">
                </div>
